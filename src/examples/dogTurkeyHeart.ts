...
import { simParamData, p1Data, p2Data, gData, numP, numG, nxG, nyG, nzG, dt, gSCData, numGPadded, sweepIters, doBenchmark, queryLength } from '../sceneConfigs/dogTurkeyHeartScene';
