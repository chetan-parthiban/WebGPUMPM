...
// Scene Definition
let scene_models : Float32Array[] = [models.turkey, models.heart, models.dog];
let scene_scales : number[]       = [0.35, 0.25, 0.5];
let scene_rots   : Euler[]        = [new Euler(-0.75,0,0), new Euler(0,0,0), new Euler(0.5,-0.8,0)];
let scene_translate : Vector3[]   = [new Vector3(-0.3,-0.5,0.5), new Vector3(-0.5,0.4,-0.3), new Vector3(0.5,0,-0.3)];
let scene_materials : number[]    = [materials.jelloB, materials.jelloP, materials.jelloFur];
let scene_velocities : Vector3[]  = [new Vector3(0,0,0), new Vector3(1.2,0,1.5), new Vector3(-1.5,0,1.5)];
