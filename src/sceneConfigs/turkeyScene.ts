...
// Scene Definition
let scene_models : Float32Array[] = [models.turkey, models.gravy];
let scene_scales : number[]       = [0.65, 1.0];
let scene_rots   : Euler[]        = [new Euler(0, 0, 0), new Euler(0, 0, 0)];
let scene_translate : Vector3[]   = [new Vector3(0, 0.2, -0.1), new Vector3(0, 0, 0)];
let scene_materials : number[]    = [materials.jelloB, materials.fluidGravy];
let scene_velocities : Vector3[]  = [new Vector3(0, -3, 3), new Vector3(0, 0, 0)];
...
// Particle Attributes
export const E = 200000.0;  // Young's Modulus (Hardness)
